    ...
    <div className="flex items-center space-x-4 p-4 bg-white border border-gray-100 rounded-lg hover:shadow-md transition-all duration-200">
      ...
      <div className="flex items-center space-x-1">
        <button
          ...
          className="w-7 h-7 flex items-center justify-center bg-rose-100 text-rose-600 rounded-full hover:bg-rose-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <button
          onClick={() => handleQuantityChange(item.quantity + 1)}
          className="w-7 h-7 flex items-center justify-center bg-rose-100 text-rose-600 rounded-full hover:bg-rose-200 transition-colors"
        >
          <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
