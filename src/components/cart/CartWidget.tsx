...
export const CartWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50">
      ...
      <button
        onClick={toggleCart}
        className="bg-rose-600 text-white p-2.5 rounded-full shadow-lg hover:bg-rose-700 transition-all duration-300 hover:scale-105 relative"
      >
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-80 sm:w-96 bg-white rounded-lg shadow-2xl border border-gray-200 max-h-[400px] sm:max-h-[500px] overflow-hidden animate-in slide-in-from-bottom-2 duration-200">
          {/* Header */}
          <div className="p-3 border-b bg-gradient-to-r from-rose-50 to-rose-50">
            ...
            {!cart || cart.cartItems.length === 0 ? (
              <div className="p-6 text-center text-gray-500">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-rose-600 text-white text-xs rounded-lg hover:bg-rose-700 transition-colors"
                >
                  Ver Productos
                </button>
              </div>
          ...
          {/* Footer */}
          {cart && cart.cartItems.length > 0 && (
            <div className="p-3 border-t bg-gradient-to-r from-gray-50 to-rose-50">
              ...
              <div className="flex space-x-2">
                ...
                <button 
                  ...
                  className="flex-1 px-3 py-2 text-xs bg-rose-600 text-white rounded-lg hover:bg-rose-700 transition-all duration-200 font-medium shadow-lg hover:shadow-xl"
                >
                  <svg className="w-3 h-3 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
